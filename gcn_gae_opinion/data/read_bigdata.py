...
def get_epinion_data(T):
    ...
    pkl_file = open(
        "/network/rit/lab/ceashpc/xujiang/eopinion_data/tmp/nodes-10000-T-38-rate-0.1-testratio-0.2-swaprate-0.1-realization-0-data-X.pkl")
    [V, E, Obs, E_X] = pickle.load(pkl_file)
...
if __name__ == '__main__':
    ...
    # print(np.sum(adj))
    # get_epinion_data(11)
    belief, uncertain, test_index = get_epinion_data(38)
    np.save("epinion_10000_0.2_T38_belief", belief)
    np.save("epinion_10000_0.2_T38_un", uncertain)
    np.save("epinion_10000_0.2_T38_testindex", test_index)
    print(1)
