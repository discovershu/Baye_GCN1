...
from gcn_gae_opinion.optimizer import OptimizerAE, OptimizerOri
from gcn_gae_opinion.input_data import load_data_epinion, load_data_pa, load_data_dc
from gcn_gae_opinion.model import GCNModelAE, GCNModelOri
...
if model_str == 'gcn_ae':
    ...
    model = GCNModelOri(placeholders, num_features, num_nodes, features_nonzero)
