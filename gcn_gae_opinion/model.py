from gcn_gae_opinion.layers import GraphConvolution, GraphConvolutionSparse, InnerProductDecoder, \
    InnerProductDecoder_Opinion
...
class GCNModelHete(Model):
    def __init__(self, placeholders, num_features, num_nodes, features_nonzero, **kwargs):
        super(GCNModelHete, self).__init__(**kwargs)
    ...
    def _build(self):
        ...
        self.sigma = GraphConvolution(input_dim=FLAGS.hidden1,
                                      output_dim=FLAGS.hidden2,
                                      adj=self.adj,
                                      act=lambda x: x,
                                      dropout=self.dropout,
...
class GCNModelOri(Model):
    def __init__(self, placeholders, num_features, num_nodes, features_nonzero, **kwargs):
        super(GCNModelOri, self).__init__(**kwargs)
...
class GCNModelHomo(Model):
    def __init__(self, placeholders, num_features, num_nodes, features_nonzero, **kwargs):
        super(GCNModelHomo, self).__init__(**kwargs)
    ...
    def _build(self):
        ...
        self.uncertain = GraphConvolution(input_dim=FLAGS.hidden1,
                                          ...
                                          dropout=self.dropout,
                                          logging=self.logging)(self.hidden1)
        self.sigma_b = tf.Variable(tf.constant(-4.0), dtype=tf.float32, name="sigma_b")
        self.sigma_u = tf.Variable(tf.constant(-4.0), dtype=tf.float32, name="sigma_u")


class GCNModelBasetate(Model):
    def __init__(self, placeholders, num_features, num_nodes, features_nonzero, **kwargs):
        super(GCNModelBasetate, self).__init__(**kwargs)
    ...
    def _build(self):
        ...
        self.basetate = GraphConvolution(input_dim=FLAGS.hidden1,
                                         output_dim=FLAGS.hidden2,
                                         adj=self.adj,
                                         act=tf.nn.sigmoid,
                                         dropout=self.dropout,
        ...
        self.pro_belief = self.belief + self.basetate * self.uncertain


class GCNModelDir(Model):
    def __init__(self, placeholders, num_features, num_nodes, features_nonzero, **kwargs):
        super(GCNModelDir, self).__init__(**kwargs)
    ...
    def _build(self):
        ...
        self.alpha3 = GraphConvolution(input_dim=FLAGS.hidden1,
                                       output_dim=FLAGS.hidden2,
                                       adj=self.adj,
                                       act=lambda x: x,
                                       dropout=self.dropout,
...
class GCNModelDir2(Model):
    def __init__(self, placeholders, num_features, num_nodes, features_nonzero, **kwargs):
        super(GCNModelDir2, self).__init__(**kwargs)
    ...
    def _build(self):
        ...
        self.uncertainty = GraphConvolution(input_dim=FLAGS.hidden1,
                                            output_dim=FLAGS.hidden2,
                                            adj=self.adj,
                                            act=tf.nn.sigmoid,
                                            dropout=self.dropout,
